...
Build 21 fixes paid-access reading after a verified monthly purchase; the monthly plan introduced in build 20 is unchanged. Build 19's annual binary and upload remain historical artifacts. Existing verified annual entitlements are honored through their original expiry, but the app offers only the new monthly SKU. See [build 19 implementation](https://github.com/Geruyang/Aurelens-iOS/blob/47a7b050fe6742d6c45d806c4edab44971faaed1/docs/Subscriptions-Implementation-build19.md) for the previous plan.
