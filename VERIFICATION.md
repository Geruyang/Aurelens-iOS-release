...
- 设置中新增隐私政策和支持链接，两个网页均已验证返回 HTTP 200。

## 尚未完成

- 0.6.2 的物理 iPhone/iPad 完整回归测试。
- Apple 构建处理完成确认、TestFlight 测试与 App Review。
